...
class AboutTuples(Koan):
    ...
    def test_tuples_of_one_look_peculiar(self):
        ...
        # Not sure if this is what they're getting at here. Tuple
        # created with 2nd element, but empty
    ...
    def test_creating_empty_tuples(self):
        self.assertEqual(tuple() , ()) # Doesn't feel like I've passed this correctly
